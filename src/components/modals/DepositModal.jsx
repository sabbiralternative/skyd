            ...
            <div className="deposit-inner ng-tns-c159-13">
              <div className="balancebox ng-tns-c159-13">
                <div className="damount ng-tns-c159-13">
                  ...
                  <div className="amt ng-tns-c159-13">
                    {data?.deposit > 0 && (
                      <p className="ng-tns-c159-13">₹ {data?.deposit}</p>
                    )}
                    {data?.bonus > 0 && (
                ...
                {data?.instantMoney > 0 && (
                  <div className="moneybox ng-tns-c159-13">
                    <p className="money ng-tns-c159-13">
                      {data?.instantMoneyTitle}
                    </p>
                    <p className="doll ng-tns-c159-13">₹{data?.instantMoney}</p>
                  </div>
                )}
                ...
                <div className="totalamt ng-tns-c159-13">
                  ...
                  <p className="doll1 ng-tns-c159-13">₹ {data?.totalAmount}</p>
                </div>
              </div>
              <div className="giftbox ng-tns-c159-13">
                ...
                <div className="gift-input ng-tns-c159-13">
                  ...
                  <p className="doll ng-tns-c159-13">₹ {data?.mainWallet}</p>
                </div>
                <img
                  loading="lazy"
                  src="/star.svg"
              ...
              {data?.bonusWallet > 0 && (
                <div className="giftbox1 ng-tns-c159-13 ng-star-inserted">
                  ...
                  <div className="gift-input ng-tns-c159-13">
                    ...
                    <p className="doll ng-tns-c159-13">₹{data?.bonusWallet}</p>
                  </div>
                  <img
                    loading="lazy"
                    src="/star.svg"
